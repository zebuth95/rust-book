...
other example:
    ...
    fn main() {
        let x = 5; // Inmutable, tipo i32 (inferido)
        println!("El valor de x es: {}", x);
    
        // Shadowing: creamos una nueva variable 'x' que "ensombrece" la anterior
        ...
        let espacios = espacios.len(); // Shadowing con cambio de tipo, ahora es usize
